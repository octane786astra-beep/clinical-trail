...
Write-Host "Step 1: Installing dependencies... [SKIPPED (Already satisfied)]"
# C:\Users\chand\AppData\Local\Python\pythoncore-3.14-64\python.exe -m pip install -r requirements.txt -q

Write-Host ""
Write-Host "Step 2: Running system tests..."

C:\Users\chand\AppData\Local\Python\pythoncore-3.14-64\python.exe -c @"
...
C:\Users\chand\AppData\Local\Python\pythoncore-3.14-64\python.exe -m uvicorn api.main:app --host 0.0.0.0 --port 8000 --reload
